    ...
    try {
      ...
      if (editDraftId) {
        ...
        await updateDraft({ 
          ...
          setupId: setupId || '', 
          schemaId: undefined,
          schemaKey,  // Pass schemaKey for menu invalidation
          prevContent  // Pass prevContent for Id comparison
        }).unwrap();
        ...
        const prevId = prevContent && typeof prevContent === 'object' ? getContentId(prevContent) : undefined;
